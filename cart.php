...
?>
             ...
             ';
                                  ...
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td> S/. <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output></td>
                                </tr>
                        ...
                        <h3 align="right"> Total  S/.<span id="sum">0</span></h3> 
    </div>
  </div>  
